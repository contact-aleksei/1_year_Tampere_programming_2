...
//   std::map<std::string,std::string, Loan*> borrowings_;
//    std::set<std::string, Loan*> names_of_borrowers_;
//    std::set<std::string, Loan*> borrowed_books_;
//    std::set<std::string, Loan*> update_of_borrowed_books_;
