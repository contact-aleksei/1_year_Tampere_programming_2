...
class Cards {
    ...
    private:
      struct Card_data {
        int data_;
        //pointer to a next card
        Card_data* next_;

      };

      // You can use this function in the implementation of method print_from_bottom_to_top.
      int recursive_print(Card_data* top, std::ostream& s, int& i);
      Card_data* top_;
      //card data pointer
      Card_data* bottom_;
